...
For the exam grade, we add up all the points you earned at the exam and divide that by the total amount of points you could receive. Then round this to one decimal and let this be $e$.
